...
TRANSLATIONS = {
    "english": {
        ...
        # Base root (auto-discovers units/ and tiles/). Separate from per-category overrides.
        "graphics.sprites_path": "Sprites Base Path",
        "graphics.animation_path": "Animation Sheets Path",
        "graphics.unit_path": "Static Sprites Path",
        "graphics.tile_path": "Tile Sprites Path",
        "graphics.disable_animations": "Disable Animations",
        "graphics.disable_static_sprites": "Disable Static Sprites",
        "graphics.use_tile_sprites": "Use Tile Sprites",
        "graphics.edit_sprites_path": "Edit Sprites Base Path",
    ...
    "chinese": {
        ...
        # 根目录：自动查找 units/、tiles/ 子目录；与下方「覆盖路径」不同
        "graphics.sprites_path": "精灵资源根目录",
        "graphics.animation_path": "动画精灵表路径",
        "graphics.unit_path": "静态精灵路径",
        "graphics.tile_path": "地形精灵路径",
        "graphics.disable_animations": "禁用动画",
        "graphics.disable_static_sprites": "禁用静态精灵",
        "graphics.use_tile_sprites": "使用地形精灵",
        "graphics.edit_sprites_path": "编辑精灵资源根目录",
        "graphics.edit_unit_path": "编辑静态精灵路径",
        "graphics.edit_animation_path": "编辑动画精灵路径",
        "graphics.edit_tile_path": "编辑地形精灵路径",
        "graphics.path_hint": "输入精灵文件夹路径",
        "graphics.path_example": "示例: assets/sprites",
