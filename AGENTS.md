...
| **强化学习学习指南（完整教程 00–17）** | [`agents/learning-guide/README.md`](agents/learning-guide/README.md) |
...
熟悉代码时：先读源码总览，再按分层打开 `agents/source-analysis/` 分篇；系统学 RL 走 `agents/learning-guide/`，算法速查走 `agents/algorithms/`，三套文档用相对路径互链。
