...
class TestMovement:
    ...
    def test_can_pass_through_friendly_unit(self, simple_grid):
        ...
        result = GameMechanics.can_move_to_position(5, 5, simple_grid, units, moving_unit=moving_unit, is_destination=False)
        assert result is True
    ...
    def test_cannot_stop_on_friendly_unit(self, simple_grid):
        ...
        result = GameMechanics.can_move_to_position(5, 5, simple_grid, units, moving_unit=moving_unit, is_destination=True)
        assert result is False
